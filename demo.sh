...
setenv OBJS "script/script2.o blob/blob.o fdtunnel/fdtunnel.o spline/spline.o smoke/smoke.o greets/greets.o sinpart/sinpart.o render/render.o render/particle.o timer/timer-lx.o"
