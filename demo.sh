...
setenv OBJS "script/script.o blob/blob.o fdtunnel/fdtunnel.o spline/spline.o smoke/smoke.o sinpart/sinpart.o render/render.o render/particle.o timer/timer-lx.o"
